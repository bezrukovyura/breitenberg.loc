...
body{
  ...
  <div class="main ">
    <div class="bhp title ">Ошибка 404</div>
    <div class="description">Страница не найдена</div>
    <a href="/" class="btn bhp button ">Вернуться на главную</a>
  </div>

  <div class="selectItem">
    <div class="title">Или перейти в раздел:</div>
    <div class="row">
      <div class="coll desktop">
        <a href="/bahils">Бахилы</a>
        <a href="#">Дезковрик</a>
        <a href="#">Санпропускник</a>
        <a href="#">Биомол</a>
        <a href="#">Деталан</a>
        <a href="#">ХАССП</a>
      </div>
